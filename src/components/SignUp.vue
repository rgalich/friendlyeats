<template>
  <a-col :span="8">
    <a-card title="S'inscrire">
            ...
            >
              <template slot="description">
                <a-row>
                  <a-col :span="24">
                    Veuillez vous
                    <a @click="$router.push({ name: 'signIn' })">connecter</a>.
                  </a-col>
                  <a-col :span="24">
                    Ou modifier votre
                    <a @click="$router.push({ name: 'sendPasswordResetEmail' })">mot de passe</a>.
                  </a-col>
                </a-row>
              </template>
            </a-alert>
      ...
      <a-divider type="horizontal"/>Vous avez déjà un compte Airbnb ?
      <a @click="$router.push({ name: 'signIn' })">Connexion</a>
    </a-card>
  </a-col>
</template>
